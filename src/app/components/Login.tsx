...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-background via-accent/20 to-secondary/10 transition-colors duration-300 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground">{t('login.welcomeBack')}</h2>
          <p className="text-muted-foreground mt-2">{t('login.signInAccount')}</p>
        </div>
        ...
        <div className="bg-card p-6 sm:p-8 rounded-2xl border-2 border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-input-background border-2 border-border focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 text-foreground transition-all duration-300"
            ...
            <div>
              <label htmlFor="password" className="block text-foreground mb-2 font-medium">
                {t('login.password')}
              </label>
              <input
                id="password"
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground text-sm sm:text-base">
              {t('login.noAccount')}{' '}
              <Link to="/signup" className="text-primary font-medium hover:underline transition-colors duration-300">
                {t('nav.signup')}
              </Link>
            </p>
          </div>
